            ...
            <div class="price-details">
                ...
                <div class="details">
                    ...
                    <form method="post" action="https://sandbox.payhere.lk/pay/checkout">
                        ...
                        <input type="hidden" name="return_url" value="http://bodimaapp.com/views/paymentFood_receving.php">
                        <input type="hidden" name="cancel_url" value="http://bodimaapp.com/viewsmvc/application/views/sucsses.php">
                        <input type="hidden" name="notify_url" value="http://bodimaapp.com/viewsmvc/application/config/payCon.php">  
