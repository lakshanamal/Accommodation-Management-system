        ...
        <div class="slide-nav">
            <ul><?php if (isset($_SESSION['email'])) { ?>
                    ...
                    <?php if ($_SESSION['level'] == 'boardings_owner') { ?>
                        <li onclick='window.location="views/myBoardingReqIshan_New.php"'>Requests</li>
                    <?php } ?>
                    <?php if ($_SESSION['level'] == 'student') { ?>
                        <li onclick='window.location="views/pendingReqIshan_New.php"'>My Requests </li>
                    <?php } ?>
                    <?php if ($_SESSION['level'] == 'student' || $_SESSION['level'] == 'boarder') { ?>
