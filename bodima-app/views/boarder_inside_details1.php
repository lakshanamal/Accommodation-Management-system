...
<head>
 ...
 <?php require "header1.php"?>
     ...
     <div class="container2">
        ...
        {$deal_list=unserialize($_GET['deal_list']);}else{$deal_list="NULL";}
        ?>

          <h1>boarders<a href="../controller/boarderListController.php?boarderlist=1"><button class="paid"><i class="fas fa-chevron-left"></i>Back</botton></a></h1>
              <div class="mid_E">
                  <div class="top_info">
                ...
                <span><a href="../controller/boarderInsideController.php?Bid=<?php echo $details['Bid'];?>"><i class="fas fa-sync-alt"></i></a></span>
                <hr/>
                </div>
                <div class="pay_list">
              ...
              <div class="mid_F">
                  ...
                  <div class="flexy" >
                    ...
                    <div class="Set_Notifications" id="Set_Notifications">
                        ...
                        <form method="post" id="setmsg" action="../controller/boarderInsideController.php?Bid=<?php echo $details['Bid']?>" >
                        <hr/>
                    ...
                    <form method="post" action="../controller/boarderInsideController.php" >
