<div class="payment-slide">
              <ul>
                  ...
                  <li id="AddAsNewBoarder" onclick="window.location='addAsBoarderView.php'"><i style="width: 30px;" class="fas fa-user-plus"></i> Add As a New Boarder <div id="noti-delivery" class="noti-order"><h5>1</h5></div></li>
