        ...
        <div class="order-typeBox">
          ...
          <div class="term">
            ...
            if (isset($_SESSION['term']) && $_SESSION['term']  == 'longTerm') { ?>
              <script>
                document.getElementById('longTerm-check').checked = true;
              </script>
            <?php   }
            ?>
          ...
          <script>
            ...
            function validateLongTerm() {
              ...
              if ((document.getElementById('longTerm-check') == null || document.getElementById('longTerm-check').checked == false) && count > 0) {
                  ...
                  <script>
                    $(document).ready(function() {
                      $(document).on('click', '#add<?php echo $i; ?>', function() {
                        element = document.getElementById('longTerm-check');
