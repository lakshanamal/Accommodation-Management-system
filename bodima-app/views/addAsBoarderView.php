<?php   require_once ('../config/database.php');
      ...
      require_once ('../controller/boarderRequestBoardingController.php');
        ...
        <div class="boxx">
            ...
            <div class="details-boxx">
                <div class="button-pay" style="width:60%;">
                    ...
                    <br/><hr>
                    <h4><span style="color: rgb(6, 165, 131); text-decoration:underline;"><a href="../controller/boarderListController.php?boarderlist=1">click here</a></span> to view My boarders</h4><br/>
                </div>
