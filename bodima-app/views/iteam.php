...
<div class="con-1" id="blur">
	...
	<?php  if (isset($_GET['popf'])){?>
        ...
        <form action="https://sandbox.payhere.lk/pay/checkout" method="post">
            ...
            <input type="hidden" name="return_url" value='http://bodimaapp.com/controller/iteamCon.php?success'>
            <input type="hidden" name="cancel_url" value="http://bodimaapp.com/controller/payhereOnlineCancelIshan.php?request_id=<?php echo $request_id;?>">
