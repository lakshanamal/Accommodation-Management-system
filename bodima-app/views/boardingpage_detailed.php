...
<body>
    ...
    <div class="box_outer">
        ...
        <div class="inner_slider">
            ...
            <div class="rnrn">
                <a class="rars" onclick="openReviewModel()"><?php if ($count == 0) {
                                                                echo "No";
                                                            } else {
                                                                echo $count;
                                                            }   ?> Reviews</a>
            ...
            <div class="resquest">
                ...
                <div class="expandable">
                    ...
                    <div class="content">
                        ...
                        <form action="../controller/studentRequestController.php" method='post'>
                    ...
                    <div class="content">
                        ...
                        <div class="addrate">
                            <input type="button" id="addrate" value="Add Reviews" onclick="openReviewModel()" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="outer-box" id="outer-box">
        <div class="rating-review">
            <div class="tri table-flex">
                <table>
                    <div onclick="closeReviewModel()" class="close-review">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div onclick="openAddReviewModel()" class="rrb">
