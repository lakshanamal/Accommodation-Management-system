<div class="payment-slide">
                ...
                <div class="orderManager">
                  ...
                  <li id="accept" onclick="window.location='../views/acceptBoardingRequestView.php'"><i style="width: 30px;" class="fas fa-clipboard-check"></i> Accepted Requests <div id="noti-order"><h5>1</h5></div></li>
