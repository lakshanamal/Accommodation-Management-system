...
<div class="con-2">
    ...
    <div class="section">
			...
			<p>*Renting For (Girls / Boys / Any One) : </p >
					...
					<input type="radio" checked name="gender" value="AnyOne"> <span>Any One</span> 
...
<?php  if (isset($_GET['pop'])){?>
        ...
        <form action="https://sandbox.payhere.lk/pay/checkout" method="post">
            <input type="hidden" name="merchant_id" value="1222017">    <!-- Replace your Merchant ID -->
            ...
            <input type="hidden" name="return_url" value='http://bodimaapp.com/controller/postBoardingCon.php?success'>
			...
			$hash = "1222017";
            $hash .= $B_post_id	;
            $hash .= number_format($post_amount_p, 2, '.', '');
            $hash .= "LKR";
