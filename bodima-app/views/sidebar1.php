  ...
  <nav class="sidebar">
    <div class="profile_info">
      ...
      <div class="name_title">
        <h4></h4><?php echo $_SESSION['first_name'] ?></h4>
      ...
      <?php if ($_SESSION['level'] == "boardings_owner") { ?>
        <li>
          ...
          <ul class="serv-show">
            ...
            <li><a href="addAsBoarderView.php">Add as New Boarder</a></li>
          </ul>
        </li>
        <li><a href="../views/myBoardingPostVIew.php"><i class="fas fa-users"></i>My Boarding Posts</a></li>
      ...
      <?php if ($_SESSION['level'] == "student") { ?>
        ...
        <li>
          ...
          <ul class="serv-show">
            ...
            <li><a href="acceptBoardingRequestView.php">Accepted Requests</a></li>
