       ...
       <div class="boxx">
            ...
            <div class="details-boxx">
                ...
                <div class="button-pay">
                    ...
                    <button type="button" class="btn4 Accept_Request"   onclick='if(confirm("Are you want to accept this Request ?")) window.location="../controller/requestIshan.php?reqAccBOwner_id=<?php echo $pending['request_id']; ?>"' > Accept Request</button>
