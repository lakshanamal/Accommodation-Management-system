...
<body>
    ...
    <div class="container1">
        ...
        <script>
            function openReport() {
                var result = '<?php echo $_GET['results'] ?>';
                window.location = "../views/displaypdf.php?results=" + result;
            }
        </script>
        <div class="container2">
            ...
            <div class="middle_b">
                ...
                <form method="post" action="../controller/boardingOwnerReportController.php">
                    <div class="mid_N">
                ...
                <div class="mid_M">
                    <div style="display:flex; justify-content:space-between;">
                        ...
                        <div class="h1btn">
                            <!-- <button onclick="openReport()">Generate</button> -->
                            <div><button class="p_edit" type="submit" name="generate_pdf" value="genarate" onclick='openReport()'> <i class="far fa-file-pdf"></i>Genarate PDF</button></div>
                        </div>
