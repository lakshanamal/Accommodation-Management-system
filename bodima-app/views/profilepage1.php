          ...
          <div class="mid_A">
            ...
            <div class="detail_table">
              ...
              <div class="list">
                ...
                <div class="pr_td" style="text-transform:capitalize;"> : <?php echo $first_name ?></div>
                </p>
              </div>
              <div class="list">
                <p>
                <div class="pr_th"><span>Last Name</span></div>
                <div class="pr_td" style="text-transform:capitalize;">: <?php echo $last_name ?></div>
                </p>
              </div>
              ...
              <div class="list">
                ...
                <div class="pr_td">: <?php if (strlen(trim($_SESSION['email'])) <= 0) {
                                        echo "None";
                                      } else {
              ...
              <div class="list">
                ...
                <div class="pr_td">: <?php echo $email ?></div>
                </p>
              </div>
              <div class="list">
                <p>
                <div class="pr_th"><span>User Type </span></div>
                <div class="pr_td">: <?php echo $level_name ?></div>
                </p>
              </div>
            </div>
          </div>
