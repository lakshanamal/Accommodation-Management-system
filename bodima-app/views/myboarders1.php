        ...
        <div class="middle_b">
          <h1>MY BOARDERS</h1>
              ...
              <h3>List view</h3>
                ...
                <hr/>
                <div class="h1btn"><div><a href="../controller/boardingOwnerReportController.php?q=1"><button class="p_edit" name="p_edit" value="Edit"><i class="fas fa-print"></i>Genarate Reports</button></a></div></div>
                <div class="list_view">
                  ...
                  <?php $boarderlist=unserialize($_GET['blist']);
                      ...
                      <div class="l_item" onclick="location.href='../controller/boarderInsideController.php?Bid=<?php echo $detail['Bid']?>'" >
