...
<?php include('../models/studentRequestModel.php');?>
        ...
        <div class="content">
          <div class="payment-slide">
              <ul>
                  ...
                  <li onclick="window.location='acceptRequestView.php'">Accepted Requests</li>
          ...
          $result=StudentRequestModel::selectPendingRequest($student_email,$connection);
