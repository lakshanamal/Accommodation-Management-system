            ...
            $result = $result .
                    ...
                    <div class='requestBlock'>
                        ...
                        <div class='requestInner'>
                            ...
                            <form action='../controller/studentRequestController.php?click1&description=$boarding_post->description&category=$boarding_post->category&B_post_id=$boarding_post->B_post_id&city=$boarding_post->city&BOid=$boarding_post->BOid' method='post'><input id='demo' class='btn6 request' type='submit' value='Request'></form>
                               </div>
                    </div>
